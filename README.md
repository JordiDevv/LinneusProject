...
- Implementación de arquitectura limpia y principios **SOLID**.
- Desarrollo de herramientas internas para diseñadores.
- Optimización de rendimiento y modularización del código.
- Dirección creativa y diseño narrativo y de gameplay.
- Gestión de la producción mediante metodologías agile y kanban.

## 🧩 Stack técnico
- **Lenguajes:** C#
- **Motor:** Unity
- **Paradigmas:** OOP, arquitectura limpia
...
- Gestión de tareas y control de versiones en equipo.
- Aplicación práctica de patrones de diseño y buenas prácticas de ingeniería de software.
